...
public class GuestWelcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgYellow.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent yellowIntent = new Intent(GuestWelcomeActivity.this,GuestShowInfoActivity.class);
                bin ="Yellow";
        ...
        imgGreen.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                bin ="Green";
                Intent greenIntent = new Intent(GuestWelcomeActivity.this,GuestShowInfoActivity.class);
        ...
        imgBlack.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                bin ="Black";
                Intent blackIntent = new Intent(GuestWelcomeActivity.this,GuestShowInfoActivity.class);
        ...
        imgOrange.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                bin ="Orange";
                Intent orangeIntent = new Intent(GuestWelcomeActivity.this,GuestShowInfoActivity.class);
        ...
        recycle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(GuestWelcomeActivity.this);
    ...
    public void onBackPressed() {
        finish();
        Intent intent = new Intent(GuestWelcomeActivity.this, GuestStartGameActivity.class);
